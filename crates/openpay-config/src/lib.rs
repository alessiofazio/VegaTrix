...
impl AppConfig {
    pub fn load() -> Result<Self, ConfigError> {
        ...
        let cfg = Self {
            ...
            environment: env_or("APP_ENV", &env_or("NODE_ENV", "development")),
            ...
            webhook_timeout_ms: env_or("WEBHOOK_TIMEOUT_MS", "5000")
                .parse()
                .unwrap_or(5000),
            ...
            rate_limit_per_minute: env_or("RATE_LIMIT_PER_MINUTE", "120").parse().unwrap_or(120),
            ...
            features: FeatureFlags {
                connector_mock: env_bool("FEATURE_CONNECTOR_MOCK", true),
    ...
    pub fn validate(&self) -> Result<(), ConfigError> {
        ...
        if self.database_url.starts_with("sqlite") && self.environment == "production" {
